...
export async function getFirstFiveQuestions(category:number){
...
export async function getSecondFiveQuestions(category:number){
...
export async function getLastFiveQuestions(category:number){
